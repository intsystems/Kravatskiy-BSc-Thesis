...
\end{frame}
%-------------------------------------------------------------------------------------
\begin{frame}{LMO-алгоритмы в нормах Шаттена $S_p$ и векторных $l_p$}
  \begin{table}
  \centering
  ...
  \begin{tabular}{lccc}
  \toprule
  Алгоритм & $\norm{\cdot}$ для LMO & Обновление LMO & Статья \\
  \midrule
    ...
    \begin{minipage}{0.9\textwidth}
      ...
      \begin{tabular}{@{}c@{\hspace{0.3cm}}l@{}}
        ...
        \begin{tabular}{@{}l@{}}
          ...
          Как комбинировать LMO-алгоритмы?
        \end{tabular}
      \end{tabular}
    \end{minipage}
  \end{center}
...
\begin{frame}{Число итераций до $F(\mX)\leq10^{-3}$ для гладкой выпуклой $F$ при постоянном \texttt{learning\_rate}}
  ...
  \begin{center}
    \begin{minipage}{0.85\textwidth}
      \normalsize
      Чем больше $k$ у Fanion-$k$, тем быстрее сходится. \\[0.2cm]
      F-/S-модификации улучшают Fanion-$k$, в том числе Muon.
    \end{minipage}
  \end{center}
\end{frame}
