...
\usepackage{enumitem}
\usepackage{caption}
\usepackage{subcaption} % Заменяет JMLR \subfigure
...
\begin{center}
\large{Кравацкий Алексей Юрьевич}
\end{center}

\vspace{0pt}

\begin{center}
\textbf{\large{\MakeUppercase{Алгоритмы оптимизации на основе неспектральных матричных норм для обучения нейронных сетей}}}
% \textbf{\large{\MakeUppercase{Неспектральные матричные нормы для обучения нейронных сетей}}}
\end{center}
...
\makeatother
\bibliography{icomp2024_conference} % Твой файл с литературой
\urlstyle{tt}                               
